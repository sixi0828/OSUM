...
#mkdir -p ./exp
#ln -s $exp_path ./exp
#dir=$exp_path/caption_task_mix1/epoch_0 # 先验证一下emotion任务的单任务的可行性,单独任务验证， 不带clap
dir=$exp_path/asr_sot_emotion_caption_task_mix/epoch_1
mkdir -p $dir
tensorboard_dir=$dir/tensorboard
num_workers=8
prefetch=10

checkpoint=$exp_path/asr_sot_emotion_caption_task_mix/epoch_1/step_109999.pt
...
#cv_data=/home/node54_tmpdata/xlgeng/manifest/asr_sot_cv.list
cv_data=/home/node54_tmpdata/xlgeng/manifest/asr_sot_emotion_cv.list
