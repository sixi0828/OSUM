...
if __name__ == '__main__':
    ...
    input_text_path = "/home/work_nfs15/asr_data/data/test_sets_format_3000/age/text"
    ...
    input_text_path = "/home/work_nfs15/asr_data/data/test_sets_format_3000/style/text"
    utils_file.copy_file(input_text_path, input_text_path + "_old")
    text_dict = utils_file.load_dict_from_scp(input_text_path)
    new_dict = {}
    for key, value in text_dict.items():
