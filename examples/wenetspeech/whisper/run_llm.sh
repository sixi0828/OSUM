...
train_config=conf/finetune_whisper_medium_gxl_adapter.yaml
exp_path=exp
dir=$exp_path/qwen2_asr_6gpus_gxl_adapter_init_asr-sot_whisper
mkdir -p $dir
...
checkpoint=exp/whisper-medium/asr_sot_emotion_caption_task_mix.pt
