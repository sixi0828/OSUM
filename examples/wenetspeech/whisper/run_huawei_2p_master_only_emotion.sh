...
HOST_NODE_ADDR=192.168.0.228
HOST_PORT=29401
# HOST_NODE_ADDR="127.0.0.1:29401"
num_nodes=1
job_id=2023

train_config=conf/config_llm_huawei_base-version_emotion-only.yaml
gxl_data_json_info_path=conf/data_config_huawei_only_emotion.yaml
...
checkpoint="/mnt/sfs/asr/code/wenet_undersdand_and_speech_xlgeng/examples/wenetspeech/whisper/exp/only_emotion_from_epoch11_with_ssl_vec/step_3749.pt"
exp_path=/mnt/sfs/asr/ckpt
data_path=/mnt/sfs/asr/data
dir=$exp_path/qwen2_multi_task_4_6gpus_gxl_adapter/only_emotion_from_epoch11_with_ssl_vec
mkdir -p $dir
...
train_data=data/tmp/tmp_emotion-only.list
