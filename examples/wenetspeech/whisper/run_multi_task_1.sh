...
train_config=conf/finetune_whisper_medium_gxl_adapter_multi_task.yaml
exp_path=exp
dir=$exp_path/qwen2_multi_task_6gpus_gxl_adapter_init_asr-sot_whisper
mkdir -p $dir
...
checkpoint=exp/qwen2_multi_task_6gpus_gxl_adapter_init_asr-sot_whisper/epoch_9.pt
...
gxl_data_json_info_path=conf/data_multi_task_1.yaml
