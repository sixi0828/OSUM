...
# 定义不同的目录路径列表
dirs=(
    "/home/node54_tmpdata/xlgeng/code/wenet_whisper_finetune_xlgeng/examples/wenetspeech/whisper/exp/qwen2_multi_task_4_6gpus_gxl_adapter/epoch_0_with_speech"
...
# 定义不同的任务类型列表
tasks=(
    "<TRANSCRIBE><BACKGROUND><INTERRUPT>"
    "<S2TCHAT>"
)
