...
gxl_data_json_info_path=conf/data_multi_task_4_with_speech.yaml


checkpoint=/home/node54_tmpdata/xlgeng/code/wenet_whisper_finetune_xlgeng/examples/wenetspeech/whisper/exp/qwen2_multi_task_4_6gpus_gxl_adapter/epoch_0_with_speech/epoch_3.pt

exp_path=/home/node54_tmpdata/xlgeng/ckpt/wenet_whisper_finetune_xlgeng/examples/wenetspeech/whisper/exp
data_path=/home/node54_tmpdata/xlgeng/data/wenet_whisper_finetune_xlgeng/examples/wenetspeech/whisper/data
dir=$exp_path/qwen2_multi_task_4_6gpus_gxl_adapter/epoch_0_with_speech_test_for_asronly
mkdir -p $dir
...
train_engine=deepspeed  # torch_ddp or deepspeed
...
train_data=conf/asr_data4lab.list
