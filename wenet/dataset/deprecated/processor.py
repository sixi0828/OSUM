...
chat_asr_path = "/mnt/sfs/asr/update_data/3500_chat_asr/gxl_all_3500_with_asr_chat.scp"
if os.path.exists(chat_asr_path):
    global_chat_dict =utils_file.load_dict_from_scp(chat_asr_path)
else:
    global_chat_dict = {}
